...
- Отчёт — потоковый парсинг int16 LE, без больших массивов; предпросмотр страницами записей ЭКГ по одной минуте на canvas, выгрузка CSV, информация о времени начала записи и о времени текущей минуты.
